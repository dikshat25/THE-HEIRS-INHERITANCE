...
import 'package:mealmatch/features/app/presentation/pages/buy_items.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'dart:convert';
import 'package:mealmatch/features/app/presentation/pages/cart_search.dart';
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => BuyItemsPage(
                      items: checklistItems, // Pass checklistItems to BuyItemsPage
                    ),
                  ),
                );
              },
              ...
              child: const Text(
                'Buy Now',
                style: TextStyle(fontSize: 22, color: Colors.white), // Larger text size
              ),
            ),
          ),
        ],
